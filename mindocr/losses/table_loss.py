...
from mindspore.nn import LossBase, L1Loss, CrossEntropyLoss


class TableMasterLoss(LossBase):
    def __init__(self, ignore_index=-1):
        super(TableMasterLoss, self).__init__()
        self.structure_loss = CrossEntropyLoss(
            ignore_index=ignore_index, reduction='mean')
        self.box_loss = L1Loss(reduction='sum')
        self.eps = 1e-12
